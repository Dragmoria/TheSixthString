        ...
        <div class="container">
            <div class="row">
                <div class="col-3 ms-4 mb-3">
                        <input type="text" class="form-control rounded-pill bg-beige-color" id="firstName" name="firstname" placeholder="Voornaam" value=<? echo htmlspecialchars($oldValue ?? '')?>>
                </div>
                <div class="col-3 ms-4 mb-3">
                                        ...
                                        <div class="col-3 ms-4 mb-3">
                                                ...
                                                <div class="col-3 ms-4 mb-3">
                                                        ...
                                                        <div class="col-auto ms-4 mb-3">
                                                            <button type="button" id="showPasswordButton" name="showPasswordButton" class="btn btn-primary rounded-pill form-check form-check-inline bg-beige-color" style="background-color:#FCB716;border-color:#FCB716" onclick="showPassword()">Wachtwoord tonen</button>
                                                        </div>
                                                            <div class="row">
